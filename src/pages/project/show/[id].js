...
{load && props.project && props.project.sector && <MapPro map={props.project.info.map} floors={props.project.sector.floor}/>}
...
export async function getStaticPaths() {
  const res = await axios('ka/projectAllPaths')
...
export async function getStaticProps({locale,params}) {
  return {props: {
      ...(await axios((locale)+'/retreive_project/?id='+params['id'])).data,
